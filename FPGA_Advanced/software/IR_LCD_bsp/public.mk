...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../IR_LCD.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10001120
SOPC_SYSID_FLAG += --sidp=0x10001120
ELF_PATCH_FLAG  += --sidp 0x10001120

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1531299496
SOPC_SYSID_FLAG += --timestamp=1531299496
ELF_PATCH_FLAG  += --timestamp 1531299496
