...
unsigned char g_pucOffscreenBufA[OFFSCREEN_BUF_SIZE];
unsigned char g_pucOffscreenBufB[OFFSCREEN_BUF_SIZE];
...
Canvas(g_sTempIntValueCanvas, &g_sTempContainerCanvas, &g_sTempExtValueCanvas,
       0,
       &g_sCFAL96x64x16, 0, 24, 96, 20,
       (CANVAS_STYLE_OUTLINE | CANVAS_STYLE_TEXT | CANVAS_STYLE_TEXT_OPAQUE |
       CANVAS_STYLE_TEXT_HCENTER | CANVAS_STYLE_TEXT_VCENTER),
       ClrDarkBlue, ClrWhite, ClrWhite, &g_sFontFixed6x8,
       g_pcTextFields[LOG_ITEM_INTTEMP], 0, 0);
Canvas(g_sTempTitleCanvas, &g_sTempContainerCanvas, &g_sTempIntValueCanvas, 0,
       &g_sCFAL96x64x16, 0, 0, 96, 24,
       (CANVAS_STYLE_OUTLINE | CANVAS_STYLE_TEXT | CANVAS_STYLE_TEXT_OPAQUE |
       CANVAS_STYLE_TEXT_HCENTER | CANVAS_STYLE_TEXT_VCENTER),
       ClrDarkBlue, ClrWhite, ClrWhite, &g_sFontFixed6x8, "TEMPERATURE",
       0, 0);
Canvas(g_sTempContainerCanvas, 0, 0, &g_sTempTitleCanvas, &g_sCFAL96x64x16,
       0, 0, 96, 64,
       0, ClrDarkBlue, ClrWhite, ClrWhite, 0, 0,
       0, 0);
...
Canvas(g_sAccelZCanvas, &g_sAccelContainerCanvas, 0, 0,
       &g_sCFAL96x64x16, 0, 48, 96, 16,
...
Canvas(g_sAIN3Canvas, &g_sAINContainerCanvas, 0, 0,
       &g_sCFAL96x64x16, 0, 48, 96, 16,
       (CANVAS_STYLE_TEXT | CANVAS_STYLE_TEXT_OPAQUE |
       CANVAS_STYLE_TEXT_HCENTER | CANVAS_STYLE_TEXT_VCENTER),
...
Canvas(g_sAINContainerCanvas, 0, 0, &g_sAIN0Canvas, &g_sCFAL96x64x16,
       0, 0, 96, 64,
       0, ClrDarkGreen, ClrWhite, ClrWhite, 0, 0,
       0, 0);
...
Canvas(g_sCurrentTitleCanvas, &g_sCurrentContainerCanvas,
       &g_sCurrentValueCanvas, 0,
       &g_sCFAL96x64x16, 0, 0, 96, 24,
       (CANVAS_STYLE_OUTLINE | CANVAS_STYLE_TEXT | CANVAS_STYLE_TEXT_OPAQUE |
       CANVAS_STYLE_TEXT_HCENTER | CANVAS_STYLE_TEXT_VCENTER),
       ClrBlack, ClrWhite, ClrWhite, &g_sFontFixed6x8, "CURRENT",
       0, 0);
Canvas(g_sCurrentContainerCanvas, 0, 0, &g_sCurrentTitleCanvas,
       &g_sCFAL96x64x16, 0, 0, 96, 64,
       0, ClrBlack, ClrWhite, ClrWhite, 0, 0,
       0, 0);
...
Canvas(g_sClockTimeCanvas, &g_sClockContainerCanvas, 0, 0,
       &g_sCFAL96x64x16, 0, 38, 96, 16,
       (CANVAS_STYLE_TEXT | CANVAS_STYLE_TEXT_OPAQUE |
       CANVAS_STYLE_TEXT_HCENTER | CANVAS_STYLE_TEXT_VCENTER),
       ClrDarkBlue, ClrWhite, ClrWhite, &g_sFontFixed6x8,
...
Canvas(g_sClockTitleCanvas, &g_sClockContainerCanvas, &g_sClockDateCanvas, 0,
       ...
       (CANVAS_STYLE_OUTLINE | CANVAS_STYLE_TEXT | CANVAS_STYLE_TEXT_OPAQUE |
       CANVAS_STYLE_TEXT_HCENTER | CANVAS_STYLE_TEXT_VCENTER),
       ClrDarkBlue, ClrWhite, ClrWhite, &g_sFontFixed6x8, "CLOCK",
       0, 0);
Canvas(g_sClockContainerCanvas, 0, 0, &g_sClockTitleCanvas, &g_sCFAL96x64x16,
       0, 0, 96, 64,
       CANVAS_STYLE_OUTLINE, ClrDarkBlue, ClrWhite, ClrWhite, 0, 0,
       0, 0);
...
Canvas(g_sStatus3Canvas, &g_sStatusContainerCanvas, 0, 0,
       &g_sCFAL96x64x16, 1, 48, 94, 12,
       (CANVAS_STYLE_TEXT | CANVAS_STYLE_TEXT_OPAQUE | CANVAS_STYLE_FILL |
       CANVAS_STYLE_TEXT_HCENTER | CANVAS_STYLE_TEXT_VCENTER),
...
Canvas(g_sStatusContainerCanvas, 0, 0, &g_sStatusTitleCanvas, &g_sCFAL96x64x16,
       0, 0, 96, 64,
       CANVAS_STYLE_OUTLINE, ClrRed, ClrWhite, ClrWhite, 0, 0,
       0, 0);
...
ClockSet(g_sClockSetter, 0, 0, 0, &g_sCFAL96x64x16, 0, 0, 96, 64,
         g_pFontFixed6x8, ClrWhite, ClrDarkGreen, &g_sTimeClock, 0);
...
tSlideMenuItem g_sMainMenuItems[] =
{
...
tSlideMenu g_sMainMenu =
{
    0,
    sizeof(g_sMainMenuItems) / sizeof(tSlideMenuItem),
    g_sMainMenuItems,
    0, 0, 0, 0
};
...
tSlideMenuItem g_sConfigMenuItems[] =
{
    { "CHANNELS", &g_sChannelsMenu, 0, 0 },
    { "PERIOD", &g_sPeriodMenu, 0, 0 },
    { "STORAGE", &g_sStorageMenu, 0, 0 },
    { "SLEEP", &g_sSleepMenu, 0, 0 },
    { "CLOCK", 0, &g_sClockSetter.sBase, ClrDarkGreen }
};
tSlideMenu g_sConfigMenu =
{
    &g_sMainMenu,
    sizeof(g_sConfigMenuItems) / sizeof(tSlideMenuItem),
    g_sConfigMenuItems,
    0, 0, 0, 0
};
...
//
//*****************************************************************************
tSlideMenuItem g_sChannelsMenuItems[] =
{
    { "CHAN 0", 0, 0, 0 },
    { "CHAN 1", 0, 0, 0 },
    { "CHAN 2", 0, 0, 0 },
...
{
    &g_sConfigMenu,
    sizeof(g_sChannelsMenuItems) / sizeof(tSlideMenuItem),
    g_sChannelsMenuItems,
    0, 0, 1, 0
};
...
tSlideMenuItem g_sPeriodMenuItems[] =
{
    { "1/32 sec", 0, 0, 0 },
    { "1/16 sec", 0, 0, 0 },
    { "1/8 sec", 0, 0, 0 },
...
{
    &g_sConfigMenu,
    sizeof(g_sPeriodMenuItems) / sizeof(tSlideMenuItem),
    g_sPeriodMenuItems,
    0, 0, 0, 0
};
...
//
//*****************************************************************************
static unsigned long g_ulLogPeriod[] =
{
    0x00000004, // 1/32
    0x00000008, // 1/16
    0x00000010, // 1/8
...
//
//*****************************************************************************
tSlideMenuItem g_sStorageMenuItems[] =
{
    { "NONE", 0, 0, 0 },
    { "USB", 0, 0, 0 },
    { "HOST PC", 0, 0, 0 },
...
{
    &g_sConfigMenu,
    sizeof(g_sStorageMenuItems) / sizeof(tSlideMenuItem),
    g_sStorageMenuItems,
    0, 0, 0, 0
};
...
//
//*****************************************************************************
tSlideMenuItem g_sSleepMenuItems[] =
{
    { "NO", 0, 0, 0 },
    { "YES", 0, 0, 0 },
};
...
{
    &g_sConfigMenu,
    sizeof(g_sSleepMenuItems) / sizeof(tSlideMenuItem),
    g_sSleepMenuItems,
    0, 0, 0, 0
};
...
//
//*****************************************************************************
tSlideMenuItem g_sViewMenuItems[] =
{
...
//    &g_sMainMenu,
		0,
    sizeof(g_sViewMenuItems) / sizeof(tSlideMenuItem),
    g_sViewMenuItems,
    0, 0, 0, 0
};
...
{
    &g_sMainMenu,
    sizeof(g_sConfirmMenuItems) / sizeof(tSlideMenuItem),
    g_sConfirmMenuItems,
    0, 0, 0, 0
};
...
SlideMenu(g_sMenuWidget, WIDGET_ROOT, 0, 0, &g_sCFAL96x64x16, 0, 0, 96, 64,
          ...
          ClrWhite, ClrRed, ClrBlack, &g_sFontFixed6x8, &g_sViewMenu, 0);
...
//*****************************************************************************
void
MenuUpdateText(unsigned long ulTextID, const char *pcText)
{
    //
    ...
    // will be shown.
    //
    if(ulTextID < NUM_TEXT_ITEMS)
    {
        usnprintf(g_pcTextFields[ulTextID], TEXT_FIELD_LENGTH, "%s", pcText);
    }
}
...
//*****************************************************************************
void
MenuSetState(tConfigState *pState)
{
    unsigned long ulIdx;
    ...
    //
    ASSERT(pState);
    ASSERT(pState->bSleep < 2);
    ASSERT(pState->ucStorage < CONFIG_STORAGE_CHOICES);
    ASSERT(pState->ulPeriod & (pState->ulPeriod < 0x2000000));

    //
    // Update each configuration menu item to match the new state
    //
    SlideMenuFocusItemSet(&g_sSleepMenu, pState->bSleep);
    SlideMenuFocusItemSet(&g_sStorageMenu, pState->ucStorage);
    SlideMenuSelectedSet(&g_sChannelsMenu, pState->usSelectedMask);

    //
    // For the period, search the values table to find the index
    //
    for(ulIdx = 0; ulIdx < sizeof(g_ulLogPeriod) / sizeof(unsigned long);
        ulIdx++)
    {
        if(pState->ulPeriod == g_ulLogPeriod[ulIdx])
        {
            SlideMenuFocusItemSet(&g_sPeriodMenu, ulIdx);
    ...
    pState->ulPeriod = g_ulLogPeriod[MENU_CONFIG_PERIOD_DEFAULT];
}
...
//*****************************************************************************
void
MenuGetDefaultState(tConfigState *pState)
{
    //
    // Check the parameters.
    //
    ...
    {
        pState->bSleep = 0;
        pState->ucStorage = CONFIG_STORAGE_NONE;
        pState->usSelectedMask = 0;
        pState->ulPeriod = 0x00000100; // 1 second
    }
}
...
//*****************************************************************************
void
MenuInit(void (*pfnActive)(tWidget *, tSlideMenuItem *, tBoolean))
{
    unsigned int uIdx;
    ...
    //
    for(uIdx = 0; uIdx < NUM_LOG_ITEMS; uIdx++)
    {
        usnprintf(g_pcTextFields[uIdx], TEXT_FIELD_LENGTH, "----");
    }
