...
extern int FlashStoreOpenLogFile(unsigned long ulStartAddr);
extern int FlashStoreWriteRecord(tLogRecord *pRecord);
extern int FlashStoreSave(void);
extern void FlashStoreErase(void);
extern void FlashStoreReport(void);
extern unsigned long FlashStoreGetAddr(void);
