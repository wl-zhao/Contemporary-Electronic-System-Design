...
extern unsigned char g_pucOffscreenBufB[];
...
//
//*****************************************************************************
extern void MenuInit(void (*pfnActive)(tWidget *, tSlideMenuItem *, tBoolean));
extern void MenuUpdateText(unsigned long ulTextID, const char *pcText);
